      ...
      <Second>
        ...
        <SecText>
          ...
          <h2>
            ...
            <br /> <i className="fas fa-angle-double-right"></i> Pour un groupe de
            <span>12 à 20</span> collégiens / lycéens
            <br /> <i className="fas fa-angle-double-right"></i> Encadré par&nbsp;
            <span>2</span> coachs certifiés à l'orientation scolaire
            <br /> <i className="fas fa-angle-double-right"></i> Pour l’entreprise, une action <span>RSE clé en main</span> ainsi qu'un avantage pour les enfants de collaborateurs
            <br /> <i className="fas fa-angle-double-right"></i> L’action est finançable à <span>100%</span> via la taxe d’apprentissage
          </h2>
        </SecText>
      </Second>
      ...
      <Third>
        ...
        <ThirdContainer>
          <ListR>
            ...
            <ul>
              <li>
                <i className="fas fa-angle-double-right"></i> Mise à disposition d'une salle.
              </li>
              <li>
                <i className="fas fa-angle-double-right"></i> 4 collaborateurs 3 x 2 heures.
              </li>
              <li>
                <i className="fas fa-angle-double-right"></i> 2 heures pour le porteur de projet.
              </li>
              <li>
                <i className="fas fa-angle-double-right"></i> 1 collaborateur 1 x 1 heure : les métiers d’avenir.
              </li>
            </ul>
          </ListR>
          ...
          <ListL>
            ...
            <ul>
              <li>
                <i className="fas fa-angle-double-right"></i> Recrutement des stagiaires et gestion des conventions de stages.
              </li>
              <li>
                <i className="fas fa-angle-double-right"></i> Encadrement et animation des jeunes pendant toute la durée du stage.
              </li>
              <li>
                <i className="fas fa-angle-double-right"></i> Accompagnement des collaborateurs intervenants.
              </li>
            </ul>
          </ListL>
        </ThirdContainer>
